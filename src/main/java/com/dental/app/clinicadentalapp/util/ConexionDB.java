...
public class ConexionDB {
    ...
    private static final String URL = "jdbc:sqlserver://localhost;databaseName=ClinicaDental;encrypt=true;trustServerCertificate=true;";
    
    // CAMBIO 2: Ahora SÍ usamos el usuario y contraseña que acabamos de crear en SSMS
    private static final String USER = "clinica_app_user"; 
